...
<?php
	...
	$insertar = "INSERT INTO t_viaje(nombre_viaje,fecha_viaje,id_guia,imagen1,imagen2,imagen3,imagen4,descripcion_viaje,ubicacion,nivel,precio_viaje,hora_reunion,estado_viaje)VALUES('$nombreviaje','$fecha_viaje','$guia','$ruta1','$ruta2','$ruta3','$ruta4','$descripcion','$ubicacion1','$nivel1','$precio1','$horaviaje','$estado_viaje')";
